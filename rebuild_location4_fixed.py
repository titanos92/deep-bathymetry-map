...
def depth_raw_to_meters(value):
    ...
    # IMPORTANT:
    #
    # New Deeper vector tiles store depth
    # in hundredths of a meter:
    #
    # 33  = 0.33 m
    # 66  = 0.66 m
    # 100 = 1.00 m
    ...
    for index, filepath in enumerate(
        ...
        if isinstance(
            ...
            for feature in depth_layer.get(
                ...
                # but give map.js the correct meters field.
                #
...
def main():
    ...
    print(
        "REBUILD LOCATION 4 - CORRECT DEPTH SCALE"
    )
    ...
    print(
        "deepmap v1 will NOT be changed."
    )
    ...
    print(
        "LOCATION 4 FIXED REBUILD COMPLETE"
    )

...
# ============================================================
# BACKUP BEFORE FIXED LOCATION 5
# ============================================================

BACKUP_POINTS = (
    WEB_DATA
    /
    "river_points_before_location5_fixed.json"
)

BACKUP_POLYGONS = (
    WEB_DATA
    /
    "river_polygons_before_location5_fixed.geojson"
)

BACKUP_META = (
    WEB_DATA
    /
    "river_meta_before_location5_fixed.json"
)
...
def backup_current_map():
    ...
    print()
    print("Creating backup before fixed location5...")
...
def load_location_polygons():
    ...
    if (
        ...
        raise RuntimeError(
            "location5 fixed GeoJSON has unexpected format."
        )
...
def main():
    ...
    print(
        "ADD FIXED LOCATION 5 TO WORKING MAP"
    )
    ...
    print(
        "Fixed location5 points:",
        len(location_points)
    )

    print(
        "Fixed location5 polygons:",

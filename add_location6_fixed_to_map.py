...
LOCATION_POINTS = (
    BASE_DIR
    /
    "depth_points_location6_fixed.csv"
)

LOCATION_POLYGONS = (
    BASE_DIR
    /
    "depth_polygons_location6_fixed.geojson"
)


# ============================================================
# BACKUP BEFORE FIXED LOCATION 6
# ============================================================

BACKUP_POINTS = (
    WEB_DATA
    /
    "river_points_before_location6_fixed.json"
)

BACKUP_POLYGONS = (
    WEB_DATA
    /
    "river_polygons_before_location6_fixed.geojson"
)

BACKUP_META = (
    WEB_DATA
    /
    "river_meta_before_location6_fixed.json"
)
...
def backup_current_map():
    ...
    print()
    print("Creating backup before fixed location6...")
...
def load_location_polygons():
    ...
    if (
        ...
        raise RuntimeError(
            "location6 fixed GeoJSON has unexpected format."
        )
...
def main():
    ...
    print(
        "ADD FIXED LOCATION 6 TO WORKING MAP"
    )
    ...
    print(
        "Fixed location6 points:",
        len(location_points)
    )

    print(
        "Fixed location6 polygons:",

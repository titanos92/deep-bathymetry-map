...
def main():
    ...
    print(
        "REBUILD LOCATION 6 - CORRECT DEPTH SCALE"
    )
    ...
    print(
        "deepmap v1, v2 and v3 will NOT be changed."
    )
    ...
    print(
        "LOCATION 6 FIXED REBUILD COMPLETE"
    )

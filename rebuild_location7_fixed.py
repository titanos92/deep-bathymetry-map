...
def main():
    ...
    print(
        "REBUILD LOCATION 7 - CORRECT DEPTH SCALE"
    )
    ...
    print(
        "deepmap v1-v4 will NOT be changed."
    )
    ...
    print(
        "LOCATION 7 FIXED REBUILD COMPLETE"
    )

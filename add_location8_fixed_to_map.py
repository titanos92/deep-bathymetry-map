...
LOCATION_POINTS = (
    BASE_DIR
    /
    "depth_points_location8_fixed.csv"
)

LOCATION_POLYGONS = (
    BASE_DIR
    /
    "depth_polygons_location8_fixed.geojson"
)


# ============================================================
# BACKUP BEFORE FIXED LOCATION 8
# ============================================================

BACKUP_POINTS = (
    WEB_DATA
    /
    "river_points_before_location8_fixed.json"
)

BACKUP_POLYGONS = (
    WEB_DATA
    /
    "river_polygons_before_location8_fixed.geojson"
)

BACKUP_META = (
    WEB_DATA
    /
    "river_meta_before_location8_fixed.json"
)
...
def backup_current_map():
    ...
    print()
    print(
        "Creating backup before fixed location8..."
    )
...
def load_location_polygons():
    ...
    if (
        ...
        raise RuntimeError(
            "location8 fixed GeoJSON has unexpected format."
        )
...
def main():
    ...
    print(
        "ADD FIXED LOCATION 8 TO WORKING MAP"
    )

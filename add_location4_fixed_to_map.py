...
LOCATION_POINTS = (
    BASE_DIR
    /
    "depth_points_location4_fixed.csv"
)

LOCATION_POLYGONS = (
    BASE_DIR
    /
    "depth_polygons_location4_fixed.geojson"
)


# ============================================================
# BACKUP BEFORE FIXED LOCATION 4
# ============================================================

BACKUP_POINTS = (
    WEB_DATA
    /
    "river_points_before_location4_fixed.json"
)

BACKUP_POLYGONS = (
    WEB_DATA
    /
    "river_polygons_before_location4_fixed.geojson"
)

BACKUP_META = (
    WEB_DATA
    /
    "river_meta_before_location4_fixed.json"
)
...
def backup_current_map():
    ...
    print()
    print(
        "Creating backup before fixed location4..."
    )
...
def load_location_polygons():
    ...
    if (
        ...
        raise RuntimeError(
            "location4 fixed GeoJSON has unexpected format."
        )
...
def main():
    ...
    print(
        "ADD FIXED LOCATION 4 TO WORKING MAP"
    )
